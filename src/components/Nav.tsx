        ...
        <nav className="bg-black border-gray-200 fixed top-0 w-full z-10">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link href="/" className="flex items-center">
                    <img src="https://cdn2.icon-icons.com/icons2/665/PNG/512/alien_pixel_icon-icons.com_60289.png" className="h-8 mr-3" />
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0">
                        ...
                        {session ? (
                            ...
                            <>
                                <li>
                                    <Link href="/login" className="block py-2 pl-3 pr-4 text-white rounded md:bg-transparent" aria-current="page">Login</Link>
                                </li>
                                <li>
